    ...
    return (
        <div className="flex mb-5" >
            ...
            <div className="ml-4 py-2" >
                <h1 className="text-lg font-bold text-white" >{videoDetails?.snippet?.title.length > 75 ? videoDetails?.snippet?.title.slice(0, 75) + '...' : videoDetails?.snippet?.title}</h1>
                <div>
                ...
                <div className="flex mt-3 items-center" >
                    ...
                    <p className="text-sm font-medium ml-2 text-white"  >{videoDetails?.snippet?.channelTitle
                    }</p>
                </div>

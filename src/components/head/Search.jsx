        ...
        <>
            <div className='lg:w-[600px]' >
                <form className='flex relative' onSubmit={(e) => {
                    ...
                    {showSuggestions && <BsSearch className="absolute my-3 mx-3 text-white " />}
                    <input id="searchbar" className='w-full border border-zinc-700 text-white bg-zinc-900 py-1 px-10 rounded-l-full focus:border-blue-500 focus:outline-none text-lg'
